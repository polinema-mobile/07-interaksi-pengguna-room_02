...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioButton lakilaki = (RadioButton) findViewById(R.id.rb_laki);
        RadioButton perempuan = (RadioButton) findViewById(R.id.rb_perempuan);

        jeniskelamin = (RadioGroup) findViewById(R.id.rg_jeniskelamin);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(new MainActivity(), NextActivity.class);
